...
所有表示[`Material`](https://www.vvpstk.com/public/Cesium/Documentation/Material.html)属性[`Property`](https://www.vvpstk.com/public/Cesium/Documentation/Property.html)的接口（不能被实例化）。
